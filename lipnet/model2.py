from keras.layers import Conv3D, ZeroPadding3D, MaxPooling3D, Dense, Activation, SpatialDropout3D, Flatten, Bidirectional, TimeDistributed, GRU, BatchNormalization, Input
...
class LipNet(object):
    ...
    def predict(self, input_batch):
        ...
        pred_model = Model(inputs=self.input_data, outputs=self.y_pred)
        return pred_model.predict(input_batch, verbose=0)